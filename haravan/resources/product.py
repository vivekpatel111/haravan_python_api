...
class Product(HaravanResource, mixins.Metafields, mixins.Events):
    ...
    def collections(self):
        return haravan.CustomCollection.find(product_id=self.id)

    def smart_collections(self):
        return haravan.SmartCollection.find(product_id=self.id)
