...
class Metafields(object):
    ...
    def metafields(self):
        return haravan.resources.Metafield.find(resource=self.__class__.plural, resource_id=self.id)
...
class Events(object):
    ...
    def events(self):
        return haravan.resources.Event.find(resource=self.__class__.plural, resource_id=self.id)
