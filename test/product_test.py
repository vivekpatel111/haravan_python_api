...
class ProductTest(TestCase):
    ...
    def setUp(self):
        ...
        self.product = haravan.Product.find(632910392)
    ...
    def test_add_metafields_to_product(self):
        ...
        field = self.product.add_metafield(haravan.Metafield({'namespace': "contact", 'key': "email", 'value': "123@example.com", 'value_type': "string"}))
