...
class ShopTest(TestCase):
    def setUp(self):
        ...
        self.fake("shop")
        self.shop = haravan.Shop.current()

    def test_current_should_return_current_shop(self):
        self.assertTrue(isinstance(self.shop,haravan.Shop))
        self.assertEqual("Apple Computers", self.shop.name)
        self.assertEqual("apple.myharavan.com", self.shop.myharavan_domain)
    ...
    def test_add_metafield(self):
        ...
        field = self.shop.add_metafield( haravan.Metafield({'namespace': "contact", 'key': "email", 'value': "123@example.com", 'value_type': "string"}))
    ...
    def test_events(self):
        ...
        for event in events:
            self.assertTrue(isinstance(event, haravan.Event))
