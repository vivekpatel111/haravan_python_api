...
class ImageTest(TestCase):
    ...
    def test_create_image(self):
        ...
        image = haravan.Image({'product_id':632910392})
        image.position = 1
    ...
    def test_get_metafields_for_image(self):
        ...
        image = haravan.Image(attributes = { 'id': 850703190, 'product_id': 632910392 })
        metafields = image.metafields()

        self.assertEqual(1, len(metafields))
        for field in metafields:
            self.assertTrue(isinstance(field, haravan.Metafield))
